...
ChicPage 同时提供移动端，支持在手机或平板上进行 Markdown 编辑、预览和导出操作，随时随地记录灵感。
...
| 移动端支持 | 响应式布局、移动端编辑器、移动端预览、触摸优化工具栏。 |
...
components/mobile/             移动端专属组件、编辑器、预览、工具栏
