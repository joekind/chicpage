...
export default function ChicEditor() {
  ...
  } = useInsertLink({ editorRef, pushHistory, setMarkdown, selection });

  const handleInsertTableAndClosePopup = useCallback(
  ...
  return (
    ...
    >
      ...
      <main className='flex flex-1 overflow-hidden relative gap-5 p-4 pt-4 md:gap-6 md:p-6 md:pt-5 xl:gap-8 xl:p-8 xl:pt-6'>
            ...
            toolbar={
              layoutMode !== 'preview' && (
                <MarkdownToolbar
                  ...
                  onInsertTable={handleInsertTableAndClosePopup}
                  onHeading={handleHeading}
                  onBold={handleBold}
                  onSeparator={handleSeparator}
